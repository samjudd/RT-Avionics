#ifndef PYRALIS_VECTOR3_H
#define PYRALIS_VECTOR3_H
...
template class PYRALIS_API Vector3<float>;
template class PYRALIS_API Vector3<double>;
typedef Vector3<float> Vector3f;
typedef Vector3<double> Vector3d;

#endif // PYRALIS_VECTOR3_H
